...
namespace IngeneoPT.Controllers
{
    public class TipoProductosController : Controller
    {
        ...
        public TipoProductosController(TalycapGlobalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoProductos != null ? 
                          ...
                          Problem("Entity set 'TalycapGlobalContext.TipoProductos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TalycapGlobalContext.TipoProductos'  is null.");
            }
            var tipoProducto = await _context.TipoProductos.FindAsync(id);
            if (tipoProducto != null)
            {
